...
#' INC_htsrec.R
#'
#' Creating an RData file of cross sectional reconciled forecasts for GDP Inc
#' 
...
#'
#' Input files: INC_arima_bf.RData
#' Output files: INC_htsrec.RData
#'
...
DFhts <- DF
save(DFhts, time_hts, 
     file="./Reconciliation/Income/ARIMA/INC_htsrec.RData")
